...
apt-get update -qq
apt-get install -qq build-essential bzr dpkg-dev git language-pack-en-base mercurial pyflakes python3-apt python3-docopt python3-coverage python3-fixtures python3-jsonschema python3-mccabe python3-pip python3-pep8 python3-requests python3-testscenarios python3-testtools python3-yaml python3-lxml squashfs-tools
