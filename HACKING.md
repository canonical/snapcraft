...
Install the needed dependencies.
    ...
    sudo apt install build-essential python3-dev python3-debian libapt-pkg-dev libsodium-dev gcc libffi-dev libssl-dev libarchive13 squashfs-tools xdelta3
