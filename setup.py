...
install_requires = [
    ...
    "click",
    "craft-application @ git+https://github.com/canonical/craft-application@feature/pydantic-2#egg=craft-application",
    "craft-archives @ git+https://github.com/canonical/craft-archives@main#egg=craft-archives",
    "craft-cli>=2.6.0",
    "craft-grammar @ git+https://github.com/canonical/craft-grammar@main#egg=craft-grammar",
    "craft-parts @ git+https://github.com/canonical/craft-parts@main#egg=craft-parts",
    "craft-platforms~=0.1",
    "craft-providers @ git+https://github.com/canonical/craft-providers@feature/2.0#egg=craft-providers",
    "craft-store @ git+https://github.com/canonical/craft-store@main#egg=craft-store",
