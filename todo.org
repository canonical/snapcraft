...
*** TODO [[file:specifications/history-to-releases.org][Snap Store API migration from v1 history to v2 releases]] [1/3]

- [X] Add bindings to Snap Store package
- [ ] Use releases bindings for CLI implementing new output
