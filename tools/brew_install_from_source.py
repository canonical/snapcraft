...
def main():
    try:
        ...
        compressed_snapcraft_sha256 = sha256_checksum(
        ...
        brew_formula_from_source_path = os.path.join(
            patched_dir, 'snapcraft.rb')
        patch_brew_formula_source(
            brew_formula_path, brew_formula_from_source_path,
            compressed_snapcraft_source, compressed_snapcraft_sha256)
...
def patch_brew_formula_source(
        original_formula_path, destination_formula_path,
        compressed_source, compressed_sha256):
