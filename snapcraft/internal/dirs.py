...
def _find_windows_data_dir(topdir):
    # On Windows we need to search for data_dir:
    #
    ...
    #
    # In this case, data_dir should be:
    # > data_dir=C:\Users\chris\AppData\Local\Temp\_MEI110562\share\snapcraft
    #
    ...
    #
    # In this case, data_dir should be:
    # > data_dir=c:\program files\python37\share\snapcraft
