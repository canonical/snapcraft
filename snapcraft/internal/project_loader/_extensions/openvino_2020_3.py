    ...
    def __init__(self, *, extension_name: str, yaml_data: Dict[str, Any]) -> None:
        ...
        self.app_snippet = {
            "environment": {
                ...
                "LC_NUMERIC": "C",
                "LD_LIBRARY_PATH": "$SNAP/openvino-platform/openvino/data_processing/dl_streamer/lib:$SNAP/openvino-platform/openvino/data_processing/gstreamer/lib:$SNAP/openvino-platform/openvino/opencv/lib:$SNAP/openvino-platform/openvino/deployment_tools/ngraph/lib:$SNAP/openvino-platform/openvino/deployment_tools/inference_engine/external/hddl/lib:$SNAP/openvino-platform/openvino/deployment_tools/inference_engine/external/gna/lib:$SNAP/openvino-platform/openvino/deployment_tools/inference_engine/external/mkltiny_lnx/lib:$SNAP/openvino-platform/openvino/deployment_tools/inference_engine/external/tbb/lib:$SNAP/openvino-platform/openvino/deployment_tools/inference_engine/lib/intel64:$SNAP/openvino-platform/openvino/deployment_tools/inference_engine/lib/aarch64:$SNAP/openvino-platform/openvino/lib",
