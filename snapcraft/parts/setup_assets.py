...
def _ensure_hook(hook_path: Path) -> None:
    ...
    hook_path.write_bytes(_PLACEHOLDER_HOOK_BYTES)
...
def _is_placeholder_hook(hook_path: Path) -> bool:
    ...
    return hook_path.read_bytes() == _PLACEHOLDER_HOOK_BYTES


_PLACEHOLDER_HOOK_BYTES = (
    b"#!/bin/true\n"
    b"# Generated by Snapcraft as a placeholder hook.\n"
)
