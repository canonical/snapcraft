...
class MultipassProvider(Provider):
    ...
    def __init__(self, instance: multipass.Multipass = multipass.Multipass(),) -> None:
    ...
    def launched_environment(
        self, *, project_name: str, project_path: pathlib.Path, base: str,
        ...
        try:
            instance = multipass.launch(
                ...
                # XXX: replace with appropriate snapcraft base image
