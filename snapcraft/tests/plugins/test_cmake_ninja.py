...
import snapcraft
from snapcraft.plugins import cmake_ninja
from snapcraft import tests


class CMakeNinjaTestCase(tests.TestCase):
    ...
    def test_get_build_properties(self):
        ...
        resulting = cmake_ninja.CMakeNinjaPlugin.get_build_properties()
        self.assertThat(resulting,
                        HasLength(len(expected)))

        for property in expected:
            self.assertIn(property, resulting)

    def test_build_referencing_sourcedir_if_no_subdir(self):
        plugin = cmake_ninja.CMakeNinjaPlugin('test-part', self.options,
