...
class PullStateTestCase(tests.TestCase):
    ...
    def test_representation(self):
        expected = 'PullState(properties: {}, schema_properties: {})'.format(
    ...
    def test_comparison_not_equal(self):
        others = [
            snapcraft.internal.states.PullState([], self.options),
            snapcraft.internal.states.PullState(self.schema_properties, None)
        ]
