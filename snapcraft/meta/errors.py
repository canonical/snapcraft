...
from snapcraft import errors, formatting_utils


class AdaptedSnapcraftError(errors.SnapcraftError):
    # XXX this is a hack, we really need to adapt old and new world
...
class SnapMetaGenerationError(AdaptedSnapcraftError):
    pass
...
class InvalidAppCommandNotFound(AdaptedSnapcraftError):
...
class InvalidAppCommandNotExecutable(AdaptedSnapcraftError):
...
class InvalidCommandChainError(AdaptedSnapcraftError):
...
class SlotValidationError(AdaptedSnapcraftError):
...
class PlugValidationError(AdaptedSnapcraftError):
...
class HookValidationError(AdaptedSnapcraftError):
