...
from snapcraft.storeapi.v2.metrics import MetricsFilter, MetricsResults
...
class StoreClientCLI(storeapi.StoreClient):
    ...
    @_login_wrapper
    def get_metrics(self, filters: List[MetricsFilter]) -> MetricsResults:
        return super().get_metrics(filters)
