...
def _media_hash(media_file: Any) -> str:
...
class StoreMetadataHandler:
    ...
    def upload(self, metadata: dict[str, Any], force: bool) -> None:
        """Upload the metadata to Dashboard."""
        url = self._base_url + f"/dev/api/snaps/{self.snap_id}/metadata"
        headers = {
    ...
    def _current_binary_metadata(self):
        ...
        url = self._base_url + f"/dev/api/snaps/{self.snap_id}/binary-metadata"
    ...
    def _build_binary_request_data(self, metadata: dict[str, Any]) -> tuple[Any, Any]:
    ...
    def upload_binary(self, metadata: dict[str, Any], force: bool) -> None:
