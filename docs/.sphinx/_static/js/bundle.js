(() => {
    ...
    var s = [
        ...
        u = ["security_storage"],
        p = ["ad_storage", "ad_user_data", "ad_personalization", "analytics_storage"],
        f = ["functionality_storage", "personalization_storage"],
        h = [
            "ad_storage",
            "ad_user_data",
            "ad_personalization",
        ...
        y = function (e) {
            ...
            ((document.cookie =
                "_cookies_accepted=" + e + "; " + n + "; samesite=lax;path=/;"),
                S(e) && _());
        },
        b = function () {
            for (
                var e = document.cookie.split(";"), t = "", n = "", o = 0;
                o < e.length;
                o++
            ) {
                for (var i = e[o]; " " == i.charAt(0); ) i = i.substring(1);
                ((n = i.substring(18, i.length)),
                    0 === i.indexOf("_cookies_accepted=") && "true" !== n && (t = n));
            }
            return t;
        },
        g = function (e) {
            return l[e] ? l[e] : l.default;
        },
        m = function (e, t) {
            return e.content[t] ? e.content[t] : e.content.default;
        },
        v = function (e) {
            var t = k(d, e);
            w(t);
        ...
        _ = function () {
            "object" ===
                ("undefined" == typeof dataLayer ? "undefined" : n(dataLayer)) &&
                dataLayer.push({ event: "pageview" });
        },
        S = function (e) {
            return "all" == e || "performance" == e;
        },
        j = (function () {
            function e(t, n, i) {
                (o(this, e),
                    (this.container = t),
                    (this.renderManager = n),
                ...
                a(e, [
                    {
                        ...
                        value: function (e) {
                            ...
                            return '\n      <div class="p-modal" id="modal">\n        <div class="p-modal__dialog" role="dialog" aria-labelledby="cookie-policy-title" aria-describedby="cookie-policy-content">\n        <header class="p-modal__header">\n          <h2 class="p-modal__title" id="cookie-policy-title">'
                                ...
                                .concat(t.notification.body1, "</p>\n          <p>")
                                .concat(t.notification.body2, "</p>\n          <p>")
                                .concat(
                                    t.notification.body3,
                                    '</p>\n          <p class="u-no-margin--bottom">\n            <button class="p-button--positive js-close" id="cookie-policy-button-accept">',
                                )
                                .concat(
                                    t.notification.buttonAccept,
                                    '</button>\n            <button class="p-button js-manage">',
                                )
                                .concat(
                                    t.notification.buttonManage,
                                    "</button>\n          </p>\n        </div>\n      </div>",
                                );
                        },
                    },
                    {
                        key: "render",
                        value: function (e) {
                            ((this.container.innerHTML = this.getNotificationMarkup(e)),
                        ...
                        value: function () {
                            ...
                            (this.container
                                ...
                                .addEventListener("click", function (t) {
                                    (y("all"), v("all"), e.destroyComponent());
                                }),
                                this.container
        ...
        L = (function () {
            function e(t, n, i) {
                (o(this, e),
                    (this.language = i),
                    (this.id = t.id),
                    (this.title = m(t, i).title),
                    (this.description = m(t, i).description),
                    (this.enableSwitcher = t.enableSwitcher),
                    (this.container = n),
                    this.element,
                    this.render());
            }
                ...
                a(e, [
                    {
                        key: "render",
                        value: function () {
                            var e = this.cookieIsTrue(),
                                t = document.createElement("div");
                            (t.classList.add("u-sv3"),
                                (t.innerHTML = "\n      "
                                    .concat(
                                        '<label class="u-float-right p-switch">\n          <input type="checkbox" class="p-switch__input js-'
                                            .concat(this.id, '-switch" ')
                                            .concat(
                                                (e || !this.enableSwitcher) &&
                                                    'checked="" ',
                                                "\n            ",
                                            )
                                            .concat(
                                    ...
                                    .concat(this.description, "</p>")),
                                this.container.appendChild(t),
                                (this.element = t.querySelector(
                                    ".js-".concat(this.id, "-switch"),
                                )));
                        },
                    },
                    {
                    ...
                    },
                    {
                        key: "isChecked",
                        value: function () {
                            return !!this.element && this.element.checked;
                        },
                    },
                    {
                        key: "getId",
                ...
                a(e, [
                    {
                        ...
                        value: function (e) {
                            ...
                            return '\n    <div class="p-modal" id="modal">\n    <div class="p-modal__dialog" role="dialog" aria-labelledby="modal-title" aria-describedby="modal-description">\n      <header class="p-modal__header">\n        <h2 class="p-modal__title" id="modal-title">'
                                ...
                                .concat(
                                    t.body4,
                                    '</p>\n      <p><button class="p-button--positive u-no-margin--bottom js-close">',
                                )
                                .concat(t.acceptAll, "</button></p>\n      <p>")
                                .concat(
                                    t.acceptAllHelp,
                                    '</p>\n      <hr />\n      <div class="controls"></div>\n      <button class="p-button js-save-preferences">',
                                )
                                .concat(
                                    t.SavePreferences,
                                    "</button>\n    </div>\n  </div>",
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            var t = this;
                            this.container.innerHTML = this.getManagerMarkup(e);
                            var n = this.container.querySelector(".controls");
                            (s.forEach(function (o) {
                                var i = new L(o, n, e);
                                t.controlsStore.push(i);
                            }),
                                this.initaliseListeners());
                        },
                    },
                        ...
                        value: function () {
                            ...
                            (this.container
                                ...
                                this.container
                                    ...
                                    .addEventListener("click", function () {
                                        (e.savePreferences(), e.destroyComponent());
                                    }));
                        },
                    },
                    {
                        key: "savePreferences",
                        value: function () {
                            var e = this.controlsStore.filter(function (e) {
                                return e.isChecked();
                            });
                            (this.controlsStore.length === e.length
                                ? y("all")
                                : this.controlsStore.forEach(function (e) {
                                      e.isChecked() && y(e.getId());
                                  }),
                                (function (e) {
    ...
    var O = function () {
            var e =
                ...
                i = function (e) {
                    (e && e.preventDefault(),
                        null === t &&
                            ((t = document.createElement("dialog")).classList.add(
                                "cookie-policy",
                            ),
                            t.setAttribute("open", !0),
                            document.body.appendChild(t),
                            new j(t, a, r).render(n),
                            document
                                .getElementById("cookie-policy-button-accept")
                                .focus()));
                },
                a = function () {
                    new E(t, r).render(n);
                ...
                c = function () {
                    if (!o) {
                        var e;
                        ((o = !0), (e = b()) && v(e));
                        var t = document.querySelector(".js-revoke-cookie-manager");
        ...
        A = P("_cookies_accepted");
    function M() {
        var e, t;
        if (
            ("all" ===
                (null === (e = A = P("_cookies_accepted")) || void 0 === e
                    ? void 0
                    : e[2]) ||
                "performance" === (null === (t = A) || void 0 === t ? void 0 : t[2])) &&
            !P("user_id")
        ) {
            var n = ([1e7] + -1e3 + -4e3 + -8e3 + -1e11).replace(
                /[018]/g,
                function (e) {
                    return (
                        e ^
            ...
            ((document.cookie = "user_id=" + n + ";max-age=31536000;"),
                dataLayer.push({ user_id: n }));
        }
    }
    A ? (M(), O()) : O(M);
})();
