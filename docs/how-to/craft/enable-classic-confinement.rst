...
.. collapse:: autotools-classic-example project file
    ...
    .. literalinclude:: code/example-classic-confinement-autotools.yaml
        :caption: snapcraft.yaml
        :language: yaml
        :lines: 2-
...
.. collapse:: makefile-lib-example project file
    ...
    .. literalinclude:: code/example-classic-confinement-make.yaml
        :caption: snapcraft.yaml
        :language: yaml
        :lines: 2-
...
.. collapse:: cmake-classic-example project file
    ...
    .. literalinclude:: code/example-classic-confinement-cmake.yaml
        :caption: snapcraft.yaml
        :language: yaml
        :lines: 2-
...
.. collapse:: python-ctypes-example project file
    ...
    .. literalinclude:: code/example-classic-confinement-python.yaml
        :caption: snapcraft.yaml
        :language: yaml
        :lines: 2-
...
.. collapse:: golang-classic-example project file
    ...
    .. literalinclude:: code/example-classic-confinement-go.yaml
        :language: yaml
        :caption: snapcraft.yaml
