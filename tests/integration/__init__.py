...
class TestCase(testtools.TestCase):
    ...
    def construct_yaml(
        ...
        snapcraft_yaml = {
            ...
            "parts": yaml_utils.safe_load(parts),
            "build-packages": yaml_utils.safe_load(build_packages),
        }
        ...
        with open("snapcraft.yaml", "w") as f:
            yaml_utils.safe_dump(snapcraft_yaml, f, default_flow_style=False)
    ...
    def set_build_package_architecture(
        ...
        with open(snapcraft_yaml_path, "w") as snapcraft_yaml_file:
            yaml_utils.safe_dump(snapcraft_yaml, snapcraft_yaml_file)
...
def add_stage_packages(
    *, part_name: str, stage_packages: List[str], snapcraft_yaml_file=None
    ...
    with open(snapcraft_yaml_file) as file_read:
        y = yaml_utils.safe_load(file_read)
    ...
    with open(snapcraft_yaml_file, "w") as file_write:
        yaml_utils.safe_dump(y, file_write)
