...
@pytest.mark.parametrize("subcommand", ["validation-sets", "list-validation-sets"])
def test_no_sets(click_run, fake_dashboard_get_validation_sets, combo, verbosity, subcommand):
    cmd = [subcommand, *verbosity]
