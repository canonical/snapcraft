...
from snapcraft.meta.snap import Snap
from snapcraft.meta.system_user import SystemUserScope
...
class SnapTests(unit.TestCase):
    ...
    def test_get_provider_content_directories_with_content_plugs(self):
        ...
        patcher = mock.patch("snapcraft.meta.snap.get_installed_snap_path")
