...
class EnvironmentTest(ProjectLoaderBaseTest):
    ...
    @mock.patch.object(snapcraft.internal.pluginhandler.PluginHandler,
    ...
    def test_config_env_dedup(self):
        ...
        environment = project_config.parts.build_env_for_part(
            part, root_part=True)
    ...
    def test_parts_build_env_ordering_with_deps(self):
        ...
        part2 = [part for part in
                 project_config.parts.all_parts if part.name == 'part2'][0]
    ...
    def test_parts_build_env_contains_parallel_build_count(self, cpu_mock):
        ...
        part1 = [part for part in
                 project_config.parts.all_parts if part.name == 'part1'][0]
