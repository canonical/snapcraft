...
class PlainboxProviderPluginTestCase(integration_tests.TestCase):
    ...
    def test_snap_with_checkbox(self):
        project_dir = 'plainbox-provider-with-checkbox'
        self.run_snapcraft('snap', project_dir)

    def test_snap_with_py_dep(self):
        project_dir = 'plainbox-provider-with-python-deps'
        self.run_snapcraft('snap', project_dir)
